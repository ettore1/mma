function varargout = field3d(varargin)
% FIELD3D Application M-file for field3d.fig
%    FIG = FIELD3D launch field3d GUI.
%    FIELD3D('callback_name', ...) invoke the named callback.
...
% Vector field
  vfield = quiver3(Xgrd,Ygrd,Zgrd,DX,DY,DZ);
else
