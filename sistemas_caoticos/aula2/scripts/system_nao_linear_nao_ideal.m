...
% Modelo Nao-Linear com Excitacao Nao-Ideal (motor CC desbalanceado)
% Caso BASE (identico ao arquivo original ..\system_nao_linear_nao_ideal.m)
yprime = zeros(5,1);
...
q =  0.3;
b =  1.5;
a =  4.0; % 0.5 a 5.0 (Parametro de Controle - torque do motor CC)
% ============================= State Space ========================
yprime(1) = z(2);
